...
// the function below is to upload the data of the question to the database using the server (NodeJSserver.js file) to parse the data
function uploadData() {
	// this is the alert notification during the data upload
	...
	// this variable stores all the values within a string that will be processed by the server and uploaded on the databse
...
function processData(postString) {
	...
	client.open('POST','http://developer.cege.ucl.ac.uk:30295/uploadData',true); // creating the POST request foor the HTTP port
